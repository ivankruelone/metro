...
///////////////////////////////////////////////////////////
	public function tabla_pendiente()
	{
       ...
       $data['titulo'] = "CAPTURA DE PEDIDOS DE COMPRA DEL METRO";
...
//////////////////////////////////////////////////////
  function insert_c()
    ...
    $prvx= $this->input->post('prvx');
    $compra= $this->input->post('compra');
    $orden= $this->input->post('orden');
    echo $orden;
    $tipo=0;  
	$this->load->model('compra_model');
    $this->compra_model->create_member_c($folio,$tipo,$cia,$factura,$prvx,$compra,$orden);
...
//////////////////////////////////////////////////////    
 ...
 function insert_d()
    ...
    $this->load->model('compra_model');
    $this->compra_model->create_member_d($id_cc,$orden,$clave,$lote,$cad,$can,$canr,$costo,$cod);
   ...
   function imprime_d($id_cc)
	{
            ...
            <tr>
            <td colspan=\"6\" align=\"center\">FACTURA DE ALMACEN METRO</td>
            </tr>
            <tr>
   ...
   function imprime_concentrado()
	{
            ...
            <tr>
            <td colspan=\"5\" align=\"center\">FACTURA DE ALMACEN METRO</td>
            </tr>
            <tr>
