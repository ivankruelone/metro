...
/////////////////////////////////////////////////////////////////
    function detalle_d($id_cc)
    {
        ...
        $this->db->join('catalogo.cat_nuevo_metro b','a.clave=b.clave_metro');
...
//////////////////////////////////////////////////////////////////////////////////
    function control_historico()
    {
       ...
       $sql="select a.*,b.nombre as salex,c.nombre as entrax from devolucion_c a 
   ...
   function detalle_d_historico($id_cc,$tit)
    {
       ...
       $this->db->select('a.*,b.susa');
       $this->db->from('metro.devolucion_d a');
       $this->db->join('catalogo.cat_nuevo_metro b', 'a.clave=b.clave_metro', 'LEFT');
       $this->db->where('id_cc',$id_cc);
       $this->db->group_by('a.clave,a.lote');
       $query = $this->db->get();
...
function imprime_detalle($id)
    {
        $tocan=0;
        $num=0;
        $sql = "SELECT a.*,b.susa from devolucion_d a
        left join catalogo.cat_nuevo_metro b on a.clave=b.clave_metro
        where a.id_cc= ?  group by a.clave,a.lote order by clave";
...
function create_member_d($id_cc,$clave,$can,$lote,$cad,$cod)
	{
        
      $sql = "SELECT * FROM catalogo.cat_nuevo_metro where clave_metro= ? ";
