<?php
    ...
    function pendiente()
    {
       ...
       $sql = "SELECT * FROM almacen.compraped where aplica<cans and tipo3='C'
        and tipo='alm' order by prv,folprv, sec";
...
//////////////////////////////////////////////////////////////////////////////////
    ...
    function control()
    {
       ...
       $this->db->select('a.*,b.razon, date(a.fecha) as fecha1');
       ...
       $query = $this->db->get();
        ...
        $tabla= "
        <table id=\"hor-minimalist-b\" cellpadding=\"5\">
        <thead>
        ...
        <th align=\"left\">Compa&ntilde;ia</th>
...
/////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////insert y delete
function create_member_c($folio,$tipo,$cia,$factura,$prvx,$compra,$orden)
	{
...
{
        $sql3 = "SELECT * FROM almacen.compraped where folprv= ? and sec = ? ";
        $query3 = $this->db->query($sql3,array($orden, $clave));

        $row3= $query3->row();
        $aplica= $row3->aplica;
        $data2 = array(
			      'aplica' => $aplica + $cantidad
			      );
		
		$this->db->where('folprv', $orden);
        $this->db->where('sec', $clave);
